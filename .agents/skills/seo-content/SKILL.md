...
name: seo-content
description: >
  Analyze content quality, clarity, search usefulness, E-E-A-T signals, and AI
  citation readiness for articles, landing pages, service pages, and website
  copy. Use when the user wants content audited for quality, depth, trust,
  readability, topical coverage, thin content, or answer-engine readiness.
  Trigger on "content quality", "E-E-A-T", "content analysis", "readability
  check", "thin content", "content audit", جودة المحتوى, تحليل المحتوى,
  ضعف المحتوى, تحسين القراءة, أو تقييم E-E-A-T.
allowed-tools:
  - Read
  - Grep
  - Glob
...
For BrightAI tasks:
- Write all content analysis, rewrite guidance, and recommendations in Arabic
- Keep URLs, heading tags, schema keys, and code examples in English
- Treat BrightAI content as Arabic-first with mixed Arabic/English product terminology and enterprise Saudi decision-maker intent
...
- For Arabic pages, do not rely on Flesch-style scores as the main quality signal
- Prioritize clarity of headings, natural Saudi phrasing, paragraph rhythm, and non-robotic wording
- Check mixed Arabic/English lines visually and semantically, especially product names and technical terms
- Flag literal translation, repeated sentence shells, and awkward keyword insertion in Arabic copy
- For paired Arabic/English pages, check intent parity rather than word-for-word equivalence
