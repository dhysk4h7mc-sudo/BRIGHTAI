...
name: seo-images
description: >
  Analyze and improve image SEO and image performance, including alt text,
  filenames, dimensions, formats, compression, responsive images, lazy loading,
  and CLS prevention. Use when the user asks to audit site images, optimize
  media for SEO, fix missing alt text, or reduce image weight. Trigger on
  "image optimization", "alt text", "image SEO", "image size", "image audit",
  تحسين الصور, صور الموقع, نص بديل, ضغط الصور, أو تحسين أداء الصور.
allowed-tools:
  - Read
  - Grep
  - Glob
...
For BrightAI tasks:
- Write all image audit findings and optimization recommendations in Arabic
- Keep file formats, HTML attributes, and code examples in English
- Evaluate images against BrightAI's Arabic marketing pages, docs, blog, and enterprise service pages rather than generic e-commerce assumptions
