...
name: seo-plan
description: >
  Create strategic SEO plans for new or existing websites, including keyword
  direction, content strategy, information architecture, competitive analysis,
  prioritization, and implementation roadmaps. Use when the user wants an SEO
  strategy, launch plan, growth roadmap, content calendar direction, or site
  architecture guidance. Trigger on "SEO plan", "SEO strategy", "content
  strategy", "site architecture", "SEO roadmap", خطة سيو, استراتيجية SEO,
  خطة محتوى, خارطة طريق, أو هيكلة الموقع.
allowed-tools:
  - Read
  - Grep
  - Glob
...
For BrightAI tasks:
- Write the strategy, roadmap, and prioritization in Arabic
- Keep URL structures, schema names, and technical examples in English
- Build plans around BrightAI's actual shape: Saudi enterprise AI positioning, Arabic-first content, English companion pages, docs, blog, sector pages, and trust/authority requirements
