...
last_updated: 2026-06-30 20:50 +03:00
...
|---|---|---|---|---|
| Build page count | 126 | 2026-06-30 | stable | `npm run build` in ~3.5s (was 125; +1 typography preview page) |
...
| Homepage CSS (gzipped) | ~17.4KB (`BaseLayout.*.css`) | 2026-06-30 | < 25KB | ✅ OK (+1.2KB from DEC-2026-032 typography additions) |
