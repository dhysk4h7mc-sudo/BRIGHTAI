...
last_updated: 2026-06-30 21:30 +03:00
...
|---|---|---|---|---|
| Build page count | 128 | 2026-06-30 | stable | `npm run build` in ~2.62s (was 127; +1 cards preview page) |
| Build time | ~2.62s | 2026-06-30 | stable | local, may vary on Render |
...
| Homepage CSS (gzipped) | ~18.4KB (`BaseLayout.*.css`) | 2026-06-30 | < 25KB | ✅ OK (+1.0KB from DEC-2026-034 card system — variants + sizes + anatomy + trend indicator) |
