...
## 1. Purpose
صفحة الملف الشخصي والأمان لإدارة بيانات المستخدم، كلمة المرور، 2FA، الجلسات، وAPI tokens حسب صلاحية المستخدم.
...
## 4. Data Source
Auth API وقاعدة SQLite للتفضيلات والجلسات والصلاحيات.
