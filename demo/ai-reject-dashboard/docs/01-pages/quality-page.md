...
## 1. Purpose
صفحة الجودة تعرض أسباب الرفض، CAPA، المخاطر، ومؤشرات QMS. الصفحة تساعد فريق الجودة على مراجعة الأنماط والتأكد من البنود التي تحتاج تحقيق أو إجراء تصحيحي.
...
## 4. Data Source
Excel عبر Backend API وتحليلات محلية، مع AI advisory عند توفر Gemini.
