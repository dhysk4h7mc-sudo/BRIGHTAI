...
## 1. Purpose
صفحة التقارير لبناء وتحميل تقارير PDF/Excel/PPTX حسب القوالب والفلاتر. فيها سجل تقارير وجدولة بريدية حسب الموجود في الكود.

Status: Implemented.

## 2. User Role
- Quality / Executive / Finance
...
## 4. Data Source
Backend Reports API وقوالب reportService، والبيانات الأصلية راجعة لـ Excel/analysis.
