      ...
      try {
        ...
        Z(R.insightsStatus, "الخادم غير متاح، يتم عرض تحليل ديمو بدون كشف مفاتيح Gemini.", ""), e2 = await async function(e3) {
          ...
          if (!o2.ok) {
            ...
            if (401 === o2.status) throw new Error("صار خلل بسيط، لا تشيل هم. نعرض لك نتيجة توضيحية آمنة الحين وتقدر تعيد المحاولة.");
    ...
    try {
      ...
      Z(R.agentStatus, "الخادم غير متاح، يتم عرض توصيات ديمو بدون كشف مفاتيح Gemini.", ""), r2 = await async function(e3) {
        ...
        if (!s2.ok) {
          ...
          if (401 === s2.status) throw new Error("صار خلل بسيط، لا تشيل هم. نعرض لك نتيجة توضيحية آمنة الحين وتقدر تعيد المحاولة.");
          if (429 === s2.status) throw new Error("تم تجاوز حد الطلبات. انتظر قليلاً.");
          return buildGeminiDemoAgentResponse(e3, new Error("صار خلل بسيط، لا تشيل هم. نعرض لك نتيجة توضيحية آمنة الحين وتقدر تعيد المحاولة."));
        }
