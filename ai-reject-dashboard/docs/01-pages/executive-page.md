...
## 1. Purpose
صفحة الإدارة التنفيذية تركّز على الصورة الكبيرة: المخاطر الأعلى، التكلفة، مؤشرات الأداء، والإيجاز الاستراتيجي. الهدف منها مساعدة الإدارة على فهم الوضع بسرعة بدون الدخول في تفاصيل تشغيلية كثيرة.
...
## 4. Data Source
Backend API مبني على Excel، وبعض النصوص التحليلية تأتي من Gemini عند توفره أو من تحليل محلي عند عدم توفره.
