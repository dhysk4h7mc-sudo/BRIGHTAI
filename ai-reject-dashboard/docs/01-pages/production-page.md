...
## 1. Purpose
صفحة الإنتاج تركز على التشغيل، الكميات، الماكينات، الدُفعات، والحالات اللي ممكن تؤثر على استمرارية الإنتاج.
...
## 4. Data Source
GET /api/rejects?source=excel من Backend، ومصدره Excel.

## 5. Related API Endpoints
- GET /api/rejects?source=excel
- GET /api/summary
- POST /api/ai/chat
