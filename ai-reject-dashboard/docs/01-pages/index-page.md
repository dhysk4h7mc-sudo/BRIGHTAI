...
## 1. Purpose
الصفحة الرئيسية تعرض ملخص عام لحالة بيانات المرفوضات والمخزون والعمر الافتراضي، وتجمع KPIs، جدول سجلات، تنبيهات، ولوحة صقر AI للمساعدة السريعة.

Status: Implemented.

## 2. User Role
- Viewer / Quality / Executive
...
## 4. Data Source
Excel عبر Backend API، مع fallback demo data إذا ملف Excel غير متاح.
