...
التطبيق يستخدم Helmet/CSP، CORS محدد، rate limiting، JWT cookies، validation، sanitization، RBAC، وaudit logging. بعض الضوابط تحتاج UAT ومراجعة إنتاج قبل التشغيل الفعلي.
